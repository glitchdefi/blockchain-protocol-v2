...
use crate::{
	slashing, weights::WeightInfo, ActiveEraInfo, BalanceOf, EraRewardPoints, Exposure,
...
pub mod pallet {
	...
	///
	#[pallet::storage]
	#[pallet::getter(fn eras_not_claimed_reward)]
	pub type ErasNotClaimedReward<T: Config> =
